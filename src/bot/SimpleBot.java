 ...
 *
 * @author Edenbai  Madi
 * @version 0.3.1 dated Apr 13, 2010
 */
package bot;
import java.util.*;
...
public class SimpleBot {
    ...
    final Map<String, String> PATTERNS_FOR_ANALYSIS = new HashMap<String, String>() {{
        ...
        put("калайсын", "howareyou");
        // whatdoyoudoing
        put("зачем\\s.*тут", "whatdoyoudoing");
        put("зачем\\s.*здесь", "whatdoyoudoing");
        put("что\\s.*делаешь", "whatdoyoudoing");
        put("чем\\s.*занимаешься", "whatdoyoudoing");
        put("не\\s.*истеп\\s.*жатсын", "whatdoyoudoing");
        // whatdoyoulike
        put("что\\s.*нравится", "whatdoyoulike");
        put("что\\s.*любишь", "whatdoyoulike");
        put("не\\s.*унайды", "whatdoyoulike");
        // iamfeelling
        put("кажется", "iamfeelling");
        put("чувствую", "iamfeelling");
        put("испытываю", "iamfeelling");
        put("сиякты", "iamfeelling");
        // yes
        put("^да", "yes");
        put("согласен", "yes");
        put("келисемин", "yes");
    ...
    final Map<String, String> ANSWERS_BY_PATTERNS = new HashMap<String, String>() {{
        put("hello", "Салам");
        put("who", "Мен жай сойлесуге арналган ботпын");
        put("name", "Менин атым Мади :)");
        put("howareyou", "Жаксы, Озин калайсын??");
        put("whatdoyoudoing", "Сол жай журген ары бери");
        put("whatdoyoulike", "Мен аяк басып жургим келеди");
        put("iamfeelling", "Не болып калды? Осы жерден толыгырак айтсаныз");
        put("yes", "Келискенинизге оте куаныштымын");
        put("bye", "Давай пока. Корискенше кун жарык");
    }};
